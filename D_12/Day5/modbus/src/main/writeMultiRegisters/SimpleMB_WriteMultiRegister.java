...
public class SimpleMB_WriteMultiRegister {
    public static byte[] makeWriteSingleRegister(int address, int quantity, int count, int value){
        
        byte [] frame = new byte[8];    // Get 같은 경우 정해져 잇다
