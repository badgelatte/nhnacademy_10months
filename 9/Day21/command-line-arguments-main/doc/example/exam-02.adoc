...
[source,java]
----
include::../../src/main/java/com/nhnacademy/example/Exam02.java[lines=4, indent=0]
    ...
include::../../src/main/java/com/nhnacademy/example/Exam02.java[lines=8, indent=0]
----
+
...
[source,java]
----
include::../../src/main/java/com/nhnacademy/example/Exam02.java[lines=5..12, indent=0]
----
