...
public class ClientServer extends Thread{
    static List<ClientServer> serverList = new LinkedList<>();
    Socket socket;
        ...
        BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(socket.getOutputStream()));
            ...
            while(!Thread.currentThread().isInterrupted()) {
                ...
                if(tokens.length > 1) {
                    ...
                    if(tokens[0].equalsIgnoreCase("ID")) {
                    ...
                    else if(tokens[0].equalsIgnoreCase("who")) {    // 내가 누군지, 서버 이름이 뭔지 알려주기
                        ...
                        if(targetId.equals("@")) {  // 모두에게 보내기
                            for(ClientServer server: ClientServer.serverList ){
